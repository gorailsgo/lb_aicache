...
license          "copyright aiCache"
description      "aiCache attach/detach"
...
A single entry of any name, e.g. 'default' or 'www.mysite.com', will mimic basic behavior of one load balancer with one pool of application servers.
...
Example: www.mysite.com, api.mysite.com, default",
...
attribute "lb/stats_uri",
  ...
  :description => "The URI for the load balancer statistics report page. This page lists the current session, queued session, response error, health check error, server status, etc. for each load balancer group. Example: /accelstattext",
  :required => "optional",
  :default => "/accelstattext",
  :recipes => [
    "lb::install_server"
  ]
